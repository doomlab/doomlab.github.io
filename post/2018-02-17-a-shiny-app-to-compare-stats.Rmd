...
Code is included below, and when our server isn't being cranky, the app is [here](http://96.242.30.151:3838/altnhst/).

Check out the project OSF page [here](https://osf.io/u9hf4/). You can download the entire app from our [github repo](https://github.com/doomlab/shiny-server) (also other shiny apps!).
