...
`r kable(curated[ curated$pubtype == "present" & curated$category == "psycho", c("citation", "link2") ], row.names = F, col.names = c("Citation", "Link")) %>% kable_styling(bootstrap_options = c("hover"))`

### Applied Statistics

`r kable(curated[ curated$pubtype == "present" & curated$category == "stats", c("citation", "link2") ], row.names = F, col.names = c("Citation", "Link")) %>% kable_styling(bootstrap_options = c("hover"))`
