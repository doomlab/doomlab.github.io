...
`r kable(curated[ curated$pubtype == "package", c("citation", "link2") ], row.names = F, col.names = c("Citation", "Link")) %>% kable_styling(bootstrap_options = c("hover"))`
...
`r kable(curated[ curated$pubtype == "article" & curated$pubstatus == "published" & curated$category == "psycho", c("citation", "link2") ], row.names = F, col.names = c("Citation", "Link")) %>% kable_styling(bootstrap_options = c("hover"))`

#### Applied Statistics

`r kable(curated[ curated$pubtype == "article" & curated$pubstatus == "published" & curated$category == "stats", c("citation", "link2") ], row.names = F, col.names = c("Citation", "Link")) %>% kable_styling(bootstrap_options = c("hover"))`
...
`r kable(curated[ curated$pubtype == "article" & curated$pubstatus == "registered" & curated$category == "psycho", c("citation", "link2") ], row.names = F, col.names = c("Citation", "Link")) %>% kable_styling(bootstrap_options = c("hover"))`

#### Applied Statistics

`r kable(curated[ curated$pubtype == "article" & curated$pubstatus == "registered" & curated$category == "stats", c("citation", "link2") ], row.names = F, col.names = c("Citation", "Link")) %>% kable_styling(bootstrap_options = c("hover"))`

### Preprints

#### Psycholinguistics, Cognitive Science

`r kable(curated[ curated$pubtype == "article" & curated$pubstatus == "preprint" & curated$category == "psycho", c("citation", "link2") ], row.names = F, col.names = c("Citation", "Link")) %>% kable_styling(bootstrap_options = c("hover"))`


#### Applied Statistics

`r kable(curated[ curated$pubtype == "article" & curated$pubstatus == "preprint" & curated$category == "stats", c("citation", "link2") ], row.names = F, col.names = c("Citation", "Link")) %>% kable_styling(bootstrap_options = c("hover"))`
