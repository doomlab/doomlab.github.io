...
Principal Investigator. Blueprint for the Enabling QUantitative Interpretation of Patient Preference Estimate Data (EQUIPPED) Database. Pfizer. $43,953. 

Principal Investigator. Building inclusive open data infrastructure for a recovering pandemic world. Trans-Atlantic Platform Social Sciences and Humanities. $199,733.
...
in Colombia: a Positive Psychology View. Psychology Beyond Borders. (2013, submitted). $8,156.38.
...
HU, 2020-current | Laurel Lord | TBD 

HU, 2019-current | Phillip Grim II | TBD 

HU, 2019-current | Jonathan Korn | TBD 

MSU, 2018-current | Arielle Cunningham | TBD 
