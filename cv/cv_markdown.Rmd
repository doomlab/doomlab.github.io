...
[Statistics Tools](http://statstools.com/)
...
\quad\quad Principle Investigator	
...
Principle Investigator: Understanding Language Learning in the Brain: Using EEG Brain 
...
Using 	a Patient Guided Approach. National Headache Foundation (2018, 
awarded). $99,592.

Statistician. Utilization of adaptive patient-centered electronic behavioral feedback 
intervention for the prevention of transformation from episodic to chronic 
migraine. Pragmatic Clinical Studies funded by the PCORI Foundation. (2014, 
submitted). $2,000,000.
...
Co-Principle Investigator: II-NEW: An Infrastructure for Distributed Research on 
...
*Note*. I have supervised many graduate and undergraduate theses, presentations, and assistants. More information abouut each of their presentations and outcomes can be found on my website under students. 
...
Experimental Methhods, Basic Statistics (ANOVA, Regression), Advanced Statistics (Multivarite, Structural Equation Modeling), Non-parametric Statistics, Cognition, Attention, Memory, Language
...
Editorial Board for Journal of Scientific Psychology \hfill 2009-Current
...
Statistics Couse Redesign, Chair \hfill 2018
