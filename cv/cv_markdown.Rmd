...
Partner Institution Faculty Mentor. Information control processes: an alternative and multidimensional approach to study their development. Horizon MSCA.  

Principal Investigator. A multilinguistic database of semantic priming and tackling linguistic's WEIRD problem. National Science Foundation (2024, submitted). $355,873.
...
HU, 2020-current | Laurel Lord | Data Science Discussions: Cross-lingual frameworks and natural annotation of crowdsourced online dictionaries 

HU, 2019-current | Phillip Grim II | Word Space in Many Languages:  Discovering the Optimal Dimensions, Algorithm, and Window Size for Building Word Vectors in 59 Languages  
